...
namespace App.Areas.Identity.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> SendCode(string returnUrl = null, bool rememberMe = false)
        {
            ...
            var input = new SendCodeViewModel { Providers = factorOptions, ReturnUrl = returnUrl, RememberMe = rememberMe };
        ...
        public async Task<IActionResult> VerifyAuthenticatorCode(VerifyAuthenticatorCodeViewModel model)
        {
            ...
            {
                ModelState.AddModelError("Mã sai");
                return View(model);
            }
        }
        //
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<IActionResult> UnlockAllAccount()
        {
            (await _context.Users.ToListAsync()).ForEach(u => u.LockoutEnd = null);
